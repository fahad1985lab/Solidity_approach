...
module Complex-Model.terminating.example.executedvotingexample-single-candidate  where
...
-- check the view function with (nat 5) after adding voter to our ledger
...
-- check the view function with (nat 3) after adding voter to our ledger
checkVoter3afterAdd3 : MsgOrError
checkVoter3afterAdd3 = ledgerAfterAdd3 1 .viewFunction "checkVoter" (nat 3)
-- evaluates to
-- theMsg (nat 1) which means true

-- check the view function with (nat 2) after adding voter to our ledger
...
-- check the view function with (nat 5) after deleting voter from our ledger
...
-- check the view function with (nat 3) after deleting voter (nat 5) from our ledger
...
-- check the view function with (nat 8) after adding voter to our ledger
